 ...
 * Canonical source. Previously misnamed delta-engine.ts.
 */

export enum CausalityLayer {
  ROOT_CAUSE = "Kořenová příčina (Systémové nastavení/Záměr)",
  PROCESS_FAILURE = "Procesní selhání (Nedodržení závazných postupu)",
...
export enum SemanticDistortion {
  ...
  CONTEXT_OMISSION = "Vytžení z kontextu (Zamlčení určujícího faktu)",
}
...
export enum LegalImpact {
  ...
  PROCEDURAL = "Procesní vada s fátalním vlivem na validitu",
}
